...
int main() {
    std::cout << "Matrix Multiplication Performance Demo (CPU Only)" << std::endl;
    std::cout << "==================================================" << std::endl;
    ...
    for (int N : sizes) {
        ...
        double cpu_time = time_matrix_multiply_cpu(N);

        std::cout << std::fixed << std::setprecision(4);
        std::cout << "CPU time: " << cpu_time << " seconds" << std::endl;
        std::cout << "Operations: " << (double)N * N * N << " multiplications" << std::endl;
        std::cout << "GFLOPS: " << ((double)N * N * N * 2) / (cpu_time * 1e9) << std::endl << std::endl;
    }
